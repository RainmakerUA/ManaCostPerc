--[=====[
		## Mana Cost Percent ver. @@release-version@@
		## ManaCostPerc.lua - module
		Code module for ManaCostPerc addon
--]=====]

local addonName = ...
ManaCostPerc = LibStub("AceAddon-3.0"):NewAddon(addonName, "AceHook-3.0" )
